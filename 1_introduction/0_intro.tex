...
\begin{figure}[!ht]
    ...
    \caption{Machine learning workflow for environment X. \\ \textcolor{gray}{\fontsize{10}{0}\selectfont DOI: 10.1109/TKDE.2018.2876857}}
...
\begin{figure}[!ht]
    ...
    (b)
    \caption{Machine learning workflow for environment Y. \\ \textcolor{gray}{\fontsize{10}{0}\selectfont DOI: 10.1109/TKDE.2018.2876857}}
