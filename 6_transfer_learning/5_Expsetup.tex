...
\begin{table}[h!]
  \centering
  \caption{Characteristics of the datasets utilized in the experiments.}
  \resizebox{\textwidth}{!}{
...
\begin{itemize}
  ...
  \item combining learned classifiers from these domains directly with the target classifier, which may impede effective knowledge transfer due to domain discrepancies. Hence, we compare the third proposed approach (HTL) with AW- CORAL \cite{sun2016return} and HE-CDTL yang2021concept.
\end{itemize}
...
\subsection{Analysis accuracy and runtime of HTL for online learning and chunk-based concept drift}
