...
\include{0_frontmatter/cover1}
\include{0_frontmatter/cover2}
...
%\part{Proposal}
% introduction
\include{1_introduction/structure}

% background
\include{2_Background/structure}

% state-of-the-art
\include{3_State-of-the-art/structure}

% imbalanced
\include{4_Imbalanced/structure}
%emerging
\include{5_Emerging/structure}
%transfer
\include{6_transfer_learning/0_intro}
\include{6_transfer_learning/4_Proposed}
\include{6_transfer_learning/5_Expsetup}


% automl_evaluation
% \include{5_Guided_Search/structure}

% our_proposal
% \include{6_analysis/structure}

% Conclusions
\include{7_Conclusions/structure}

% PDR SotA
% \include{3_PDR_SotA/structure}	

%\part{Development}
% suitability analisys
%\include{4_suitability/structure}	

% SLE SotA
%\include{5_sle_sota/structure}	

% SLE wrist models
%\include{6_sle_wrist/structure}	

% SLE UWB
%\include{7_sle_uwb/structure}	

% Evaluation of wrist-worn PDR
%\include{8_evaluation/structure}

% SHE from the wrist
%\include{9_ihde/structure}

%\part{Conclusions}
% Conclusions
%\include{10_conclusions/structure}
